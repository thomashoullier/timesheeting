...
TODO: Do not use the BOM, as it is not recommended to have it nowadays.
So how do we test we are in UTF-8?
Load the first characters in UTF-8 and check them?

\textit{Test: } IRS1-GEN-030 File encoding, IRS1-GEN-010 File type.

\paragraph{MT-EXP-070 -- Line endings}
The \emph{file} shall be loaded as a set of UTF-8 characters.
