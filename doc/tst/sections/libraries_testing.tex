...
The Date initialized in LR-DAT-010 shall be accessed through its
...
The Date initialized in LR-DAT-040 shall be converted to a UNIX
...
The day/moth/year string is then queried, it must be equal to
