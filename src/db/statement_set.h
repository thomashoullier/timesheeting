...
public:
  ...
  /** @brief db_lib::Statement for querying the list of tasks for a given project. */
  db_lib::Statement select_tasks;
  /** @brief db_lib::Statement for querying the list of active tasks for a given
      project. */
  ...
  /** @brief db_lib::Statement for querying the list of entries over a given date
      range. */
  ...
  /** @brief db_lib::Statement for querying the total duration of entries over
      a date range. */
  db_lib::Statement select_duration;
  /** @brief db_lib::Statement for querying the entry contained in entrystaging. */
