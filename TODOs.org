...
*** TODO Realign the specifications with the new additions for v0.8 release
...
+ Now add the "Tested by" link to all requirements.

*** TODO Add the uplink from libraries/modules requirements to top requirements.
