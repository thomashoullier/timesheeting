...
*** TODO Make the status bar a singleton
ADDED: [2024-09-01 Sun]
...
both. The choice which would make the most choice is to enforce an
...
*** TODO Implement the weekly report
...
*** TODO Ergonomy: Add the day of the week on the current day display in entries
...
*** TODO Center the items display in menus
ADDED: [2024-09-08 Sun]

*** TODO Refresh the reports whenever entries are updated
ADDED: [2024-09-08 Sun]
