...
*** TODO Day/Week/Month/Year for weekly report
ADDED: [2025-01-24 Fri]
Make the weekly report screen able to display the same information
for a given day, week, month or year.
Add togglable individual tasks too.
